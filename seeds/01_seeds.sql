...
INSERT INTO properties (owner_id, title, description, thumbnail_photo_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, street, city, province, post_code) VALUES (1, 'Apartment', 'description', 'www.example.com/url', 'www.example.com/different_url', 111, 2, 2, 2, 'Canada', '99ST', 'Red Deer', 'AB', 'T6G 9R3');
INSERT INTO properties (owner_id, title, description, thumbnail_photo_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, street, city, province, post_code) VALUES (1, 'Shed', 'This is a shed', 'description', 'www.example.com/different_url', 10, 0, 0, 0, 'Canada', '99ST', 'Calgary', 'AB', 'T6G 9R3');
